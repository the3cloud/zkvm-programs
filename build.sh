...
target/release/compute-imageid $TARGET_ELF_OUTPUTS_PATH/$R0_TLS_ELF_FILENAME > $TARGET_ELF_OUTPUTS_PATH/$R0_TLS_ELF_FILENAME.txt || exit 1
target/release/compute-vkey $TARGET_ELF_OUTPUTS_PATH/$SP1_TLS_ELF_FILENAME > $TARGET_ELF_OUTPUTS_PATH/$SP1_TLS_ELF_FILENAME.txt || exit 1
